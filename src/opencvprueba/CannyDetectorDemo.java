...
public class CannyDetectorDemo {
    ...
    public CannyDetectorDemo(String[] args) {
        String imagePath = "C:\\Users\\PC-PUBG\\Documents\\WERO\\TT2\\engranaje.jpg";//args.length > 0 ? args[0] : "../data/fruits.jpg";
        src = Imgcodecs.imread("C:\\Users\\PC-PUBG\\Documents\\WERO\\TT2\\engrane.jpg");
        if (src.empty()) {
